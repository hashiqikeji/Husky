	...
	<nav class="navbar navbar-default">
		...
		<script type="text/javascript">
            ...
            $(function(){
                var content = "";
                $.post(
                    "${pageContext.request.contextPath}/product?method=varietyList",
                    function(data){
                        //[{"cid":"xxx","cname":"xxxx"},{},{}]
                        //动态创建<li><a href="#">${variety.cname }</a></li>
                        for(var i=0;i<data.length;i++){
                            content+="<li><a href='${pageContext.request.contextPath}/product?method=productList&vid="+data[i].vid+"'>"+data[i].vname+"</a></li>";
                        }
