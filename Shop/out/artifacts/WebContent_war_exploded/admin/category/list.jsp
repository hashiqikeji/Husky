					...
					<table cellspacing="0" cellpadding="1" rules="all"
						...
						<c:forEach items="${varietyList}" var="variety">
							...
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="18%">${variety.vid}</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="17%">${variety.vname}</td>
								...
								<td align="center" style="HEIGHT: 22px">
									<a href="${pageContext.request.contextPath}/product?method=delVariety&vid=${variety.vid}">
